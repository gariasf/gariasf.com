<template>
    ...
    <!-- Twitter Icon -->
    <svg v-if="iconName=='twitter'" class="social-icon pointer twitter" viewBox="0 0 24 24">
    ...
    <!-- Github Icon -->
    <svg v-else-if="iconName=='github'" class="social-icon pointer github" viewBox="0 0 24 24">
    ...
    <!-- Telegram Icon -->
    <svg v-else-if="iconName=='telegram'" class="social-icon pointer telegram" viewBox="0 0 24 24">
    ...
    <!-- Mail Icon -->
    <svg v-else-if="iconName=='mail'" class="social-icon small pointer email" viewBox="0 0 24 24">
