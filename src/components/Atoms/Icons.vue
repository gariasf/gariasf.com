<template>
    <!-- The shown icon is determined by the 'name' prop, the v-if directive takes care of rendering one or the other depending on the prop value -->

<!--Social Icons-->
    <!-- Twitter Icon -->
    <svg v-if="name=='twitter'" :class="['svg-icon', {'pointer': pointer == 'true'}, 'twitter', {'small': isSmall == 'true'}]" viewBox="0 0 24 24">
    ...
    <!-- Github Icon -->
    <svg v-else-if="name=='github'" :class="['svg-icon', {'pointer': pointer == 'true'}, 'github', {'small': isSmall == 'true'}]" viewBox="0 0 24 24">
    ...
    <!-- Telegram Icon -->
    <svg v-else-if="name=='telegram'" :class="['svg-icon', {'pointer': pointer == 'true'}, 'telegram', {'small': isSmall == 'true'}]" viewBox="0 0 24 24">
    ...
    <!-- Mail Icon -->
    <svg v-else-if="name=='mail'" :class="['svg-icon', {'pointer': pointer == 'true'}, 'email', {'small': isSmall == 'true'}]" viewBox="0 0 24 24">
...
<!--UI Icons-->
    <!-- Back Arrow -->
    <svg v-else-if="name=='arrow-back'" :class="['svg-icon', {'pointer': pointer == 'true'}, 'arrow-back', {'small': isSmall == 'true'}]" viewBox="0 0 24 24">
    ...
    <!-- Account -->
    <svg v-else-if="name=='account'" :class="['svg-icon', {'pointer': pointer == 'true'}, 'account', {'small': isSmall == 'true'}]" viewBox="0 0 24 24">
        <path fill="#000000" d="M12,4A4,4 0 0,1 16,8A4,4 0 0,1 12,12A4,4 0 0,1 8,8A4,4 0 0,1 12,4M12,14C16.42,14 20,15.79 20,18V20H4V18C4,15.79 7.58,14 12,14Z" />
    </svg>

    <!-- Array -->
    <svg v-else-if="name=='array'" :class="['svg-icon', {'pointer': pointer == 'true'}, 'array', {'small': isSmall == 'true'}]" viewBox="0 0 24 24">
