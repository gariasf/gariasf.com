...
<!--Social Icons-->
    <!-- Twitter Icon -->
    <svg v-if="iconName=='twitter'" :class="['svg-icon', 'pointer', 'twitter', {'small': isSmall == 'true'}]" viewBox="0 0 24 24">
    ...
    <!-- Github Icon -->
    <svg v-else-if="iconName=='github'" :class="['svg-icon', 'pointer', 'github', {'small': isSmall == 'true'}]" viewBox="0 0 24 24">
    ...
    <!-- Telegram Icon -->
    <svg v-else-if="iconName=='telegram'" :class="['svg-icon', 'pointer', 'telegram', {'small': isSmall == 'true'}]" viewBox="0 0 24 24">
    ...
    <!-- Mail Icon -->
    <svg v-else-if="iconName=='mail'" :class="['svg-icon', 'pointer', 'email', {'small': isSmall == 'true'}]" viewBox="0 0 24 24">
